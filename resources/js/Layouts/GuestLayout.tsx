...
export default function Guest({ children }: PropsWithChildren) {
    ...
    return (
        <>
            <nav className="bg-blue-300 fixed z-20 top-0 start-0 w-full border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
                        ...
                        <div className="z-50 hidden my-4 text-base list-none bg-blue-300 divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700" id="language-dropdown-menu">
                        ...
                        <div className="text-center">
                            <button
                                ...
                                type="button"
                                data-drawer-target="navbar-drawer"
                                data-drawer-show="navbar-drawer"
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-language">
                        <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-blue-300 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            {
                                menus.map((menu) =>
                                    <li>
                                        <NavLink href={menu.route} active={route().current(menu.route)}>
                                            {menu.title}
                                        </NavLink>
                                    </li>
                                )
                    ...
                    {/* drawer component */}
                    <div id="navbar-drawer" className="fixed top-0 right-0 z-40 h-screen p-4 overflow-y-auto md:hidden transition-transform translate-x-full bg-gray-50 w-80 dark:bg-gray-800" tabIndex={-1} aria-labelledby="drawer-right-label">
                        <button type="button" data-drawer-hide="navbar-drawer" aria-controls="navbar-drawer" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 absolute top-2.5 end-2.5 inline-flex items-center justify-center dark:hover:bg-gray-600 dark:hover:text-white" >
                        ...
                        <ul className="flex flex-col font-medium p-4 gap-y-4 md:p-0 mt-4 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-blue-300 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            {menus.map((menu) =>
                                <li>
                                    <NavLink
                                        href={menu.route}
